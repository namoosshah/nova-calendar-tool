...
export default {
  ...
  data() {
    return {
      ...
      doctor_id: this.currentEvent !== null ? this.currentEvent.event.doctor_id.toString() : '',
      patient_id: this.currentEvent !== null ? this.currentEvent.event.patient_id.toString() : '',
      live_session_id: this.currentEvent !== null ? this.currentEvent.event.live_session_id.toString() : ''
    }
  },
  methods: {
    changeStart(value) {
